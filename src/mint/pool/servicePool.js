            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(new bignumber_js_1.default(this.temp.ne).comparedTo(new bignumber_js_1.default(ne)) == -1)) return [3 /*break*/, 11];
                        console.log("index=[" + this.temp.index + "], nonce=[" + this.temp.nonce + "], ne=[" + ne + "]");
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 10, , 11]);
                        if (!(this.temp.minNE && new bignumber_js_1.default(this.temp.minNE).comparedTo(new bignumber_js_1.default(ne)) < 1)) return [3 /*break*/, 3];
                    ...
                    case 4:
                        ...
                        d = rest[0];
                        if (!(new bignumber_js_1.default(d.ne).comparedTo(new bignumber_js_1.default(ne)) == -1)) return [3 /*break*/, 6];
                        d.ne = ne;
                        d.nonce = nonce;
                        d.timestamp = Date.now();
                        return [4 /*yield*/, collection_1.mintCollections.update(d)];
