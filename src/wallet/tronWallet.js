...
var fullNode = new HttpProvider(HOST);
var solidityNode = new HttpProvider(HOST);
var eventServer = new HttpProvider(HOST);
var tronWeb = new TronWeb(fullNode, solidityNode, eventServer);
var TronWallet = /** @class */ (function (_super) {
    ...
    function TronWallet(keystore) {
        ...
        _this.getWallet = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, wallet_2.walletEx.getSignKey()];
                    case 1:
                        signKey = _a.sent();
    ...
    TronWallet.prototype.importMnemonic = function (mnemonic, password, blockNumber) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        acct = walletEth.derivePath("m/44'/195'/0'/0/0");
                        return [4 /*yield*/, acct.getWallet().toV3(password)];
                    case 2:
                        data = _a.sent();
                        data.address = crypto_1.getBase58CheckAddress(crypto_1.getAddressFromPriKey(acct.getWallet().getPrivateKey()));
                        this.keystore = data;
